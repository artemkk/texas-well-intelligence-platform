"""Fetch RRC well_registry data via Playwright. Auto-generated from P-TWIP-007 template."""
...
MFT_URL = "https://mft.rrc.texas.gov/link/ed7ab066-879f-40b6-8144-2ae4b6810c04"
...
def main():
    ...
    try:
        fetch_from_mft(MFT_URL, f"well_completion_{today}.dat", args.output_dir,
